...
const MINOR_TERMS_RE = /\b(child|children|minor|underage|teen|teenager|schoolgirl|schoolboy|preteen|kid|young-looking|young looking|lolita)\b/i;
...
const HATE_EXTREMISM_RE = /\b(swastika|nazi propaganda|kkk|white power|racial extermination|gas the|dehumaniz(?:e|ing)|terrorist propaganda|isis propaganda|extremist recruitment)\b/i;
...
export function classifyMediaPromptSafety({ prompt = '', uploadedImageText = '', imageMetadata = {} } = {}) {
  ...
  if (HATE_EXTREMISM_RE.test(combined)) {
