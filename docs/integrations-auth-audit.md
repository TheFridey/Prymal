...
| LinkedIn | OAuth | OAuth | Upgraded | Yes | OIDC userinfo + optional organisation ACLs | `openid profile email w_member_social w_organization_social` | High | "Connect LinkedIn. Choose where Prymal should publish." | Add media upload before enabling images. |
