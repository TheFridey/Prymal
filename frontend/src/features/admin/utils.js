...
export function getActivityTitle(entry) {
  ...
  const titles = {
    ...
    'first_agent_message_sent': 'First user chat message',
    'first_agent_response_completed': 'First completed assistant reply',
    'first_lore_document_added': 'First LORE document added',
    'first_lore_question_asked': 'First LORE question with sources',
    'first_memory_saved': 'First manual memory save',
    'first_media_generation_started': 'First media job started',
    'first_media_generation_completed': 'First media output completed',
    'first_workflow_created': 'First workflow created',
    'first_workflow_run_completed': 'First workflow run completed',
    'first_win.completed': 'First win milestone',
